...
docker run -p 9880:9880 -d --network=apache_network -v nifi_conf:/opt/nifi/nifi-current/conf -v nifi_state:/opt/nifi/nifi-current/state -v nifi_hdfs:/opt/nifi/nifi-current/hdfs -e NIFI_WEB_HTTP_PORT='9880' --name=nifi apache/nifi
docker cp nifi-hdfs nifi:/opt/nifi/nifi-current/hdfs
